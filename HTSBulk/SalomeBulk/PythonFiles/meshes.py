...
if areSubmeshGroupsWanted:
  ...
  ### 3D solids:
  NETGEN_1D_2D_3D_3 = assemblyMesh.Tetrahedron(algo = smeshBuilder.NETGEN_1D2D3D, geom = submeshSolidGroup)
  NETGEN_3D_Parameters_2 = NETGEN_1D_2D_3D_3.Parameters()
  NETGEN_3D_Parameters_2.SetMaxSize( 0.001 )
